...
hotel(24,'Dona Rosa','Km 34',4,250,500,100,11,34).
...
registro(1,10,30,'44206',4,3).
registro(2,10,30,'44659',2,5).
registro(3,10,31,'44744',5,5).
registro(4,11,8,'44351',6,6).
registro(5,11,30,'44250',2,6).
registro(6,12,30,'44226',5,5).
registro(7,12,31,'44606',6,4).
registro(8,13,18,'44474',3,9).
registro(9,13,24,'44459',1,5).
registro(10,14,7,'44209',4,4).
registro(11,14,26,'44200',6,4).
registro(12,15,24,'44685',5,2).
registro(13,15,25,'44250',3,1).
registro(14,17,23,'44231',1,1).
registro(15,18,22,'44605',3,7).
registro(18,19,21,'44679',3,4).
registro(19,20,2,'44261',4,5).
registro(20,21,18,'44231',4,4).
registro(21,22,15,'44377',2,9).
registro(22,23,6,'44403',2,4).
registro(23,24,3,'44681',3,1).
registro(24,24,10,'44359',1,9).
registro(25,1,1,'44198',3,5).
registro(26,1,11,'44441',1,8).
registro(27,1,12,'44326',4,1).
registro(28,1,4,'44402',6,1).
registro(29,1,5,'44239',2,10).
registro(30,2,13,'44468',5,1).
registro(31,2,14,'44589',2,4).
registro(32,2,16,'44398',6,6).
registro(33,2,9,'44210',4,6).
registro(34,3,17,'44201',4,4).
registro(35,3,19,'44731',2,10).
registro(36,3,20,'44592',5,5).
registro(37,4,21,'44225',4,6).
registro(38,4,27,'44488',5,10).
registro(39,4,28,'44574',1,8).
registro(40,5,29,'44222',6,8).
registro(41,5,33,'44635',4,6).
registro(42,5,1,'44327',4,8).
registro(43,6,11,'44274',2,10).
registro(44,6,12,'44722',4,6).
registro(45,6,4,'44626',4,3).
...
menu:- write('
    ...
    ---------Bienvenido al sistema experto de hoteles---------

    Por favor selecione una de las siguientes opciones para buscar:
...
% --- CRITERIO DE SELECION DE HOTEL ---

opcion(OPCION):- (
    OPCION == 1 -> presupuesto(), menu();
    OPCION == 2 -> idioma, menu();
    OPCION == 3 -> calidad, menu();
    OPCION == 4 -> clima, menu();
    OPCION == 5 -> reportes();
    OPCION == 6 -> salir();
    write('La Opcion Seleccionada no es valida \n\n\n')
).

presupuesto:- write('Hola desde presupuesto').
idioma:- write('Hola desde idioma').
calidad:- write('Hola desde cantidad de estrellas').
clima:- write('Hola desde clima').
reportes:- write('Hola desde reportes').
salir:- write('salir :)').
